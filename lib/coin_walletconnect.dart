...
///
/// This barrel exposes the WalletConnect primitives: the v2 envelope crypto
/// (X25519 -> HKDF symKey, SHA-256 topic, ChaCha20-Poly1305 type-0/1
/// envelopes), the EdDSA relay-auth JWT (did:key), the `wc:` URI (v1 + v2),
/// and the WC v1 AES-CBC+HMAC cipher - plus the underlying in-house primitives
/// they build on. The higher-level Sign/Auth protocol engine is not part of
/// this build.
library;
...
export 'src/ext/walletconnect/wc_verify.dart';
